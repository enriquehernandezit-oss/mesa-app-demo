...
| Compose flows | `presentation: 'modal'` on `/rank`, `/dish`, `/planes/nuevo` and `/planes/invitar`; drag-to-dismiss runs the same `beforeRemove` guards as the back gesture. |
