...
export const es = {
  ...
  'rankings.saved_restaurants': 'Restaurantes',
  'rankings.saved_dishes_tab': 'Platos',
  'rankings.saved_events_tab': 'Eventos',
  'rankings.no_saved_events': 'Aún no has guardado eventos.',
  'rankings.no_saved_events_body': 'Toca el marcador en un evento para tenerlo a mano aquí.',
  'rankings.browse_events': 'Ver eventos',
  'rankings.saved_events_error': 'No se pudieron cargar tus eventos.',
  'rankings.going_events_tab': 'Voy',
  'rankings.no_going_events': 'Todavía no vas a nada.',
  'rankings.no_going_events_body': 'Marca "Voy" en un evento y aparece aquí, con recordatorios.',
  ...
  'notifications.events': 'Eventos a los que vas',
  ...
  'events.live_chip': 'En vivo · hasta las {time}',
  'events.save_cta': 'Guardar evento',
  'events.unsave_cta': 'Quitar de guardados',
  'events.saved_toast': 'Guardado en Guardados · Eventos',
  'events.save_error': 'No se pudo guardar el evento.',
  ...
  'events.empty_range': 'Nada en esas fechas.',
  'events.dates_title': 'Elegir fechas',
  'events.dates_hint': 'Toca un día, o dos para un rango.',
  'events.dates_apply': 'Aplicar',
  'events.dates_clear': 'Quitar fechas',
  'events.dates_close': 'Cerrar',
  'events.dates_prev_month': 'Mes anterior',
  'events.dates_next_month': 'Mes siguiente',
  ...
  'events.cancelled_title': 'Este evento fue cancelado',
  'events.cancelled_body': 'El lugar o Mesa lo quitó del calendario. Tu RSVP no aplica a nada más.',
